...
import { CreateBulkEventResultUseCase } from "../results/create-bulk-event-result-use-case"

export function makeCreateBulkEventResultUseCase(){
    ...
    const useCase = new CreateBulkEventResultUseCase(eventResultsRepository, eventsRepository, competitorsRepository)
