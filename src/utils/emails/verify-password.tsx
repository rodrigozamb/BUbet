...
export default function BUBetAccountValidationEmail({
  verificationLink,
  ...
  return (
    <Html>
      <Head />
      <Body style={main}>
        <Preview>BUBet - Ativação de Conta</Preview>
        <Container style={container}>
          <Section style={coverSection}>
            ...
            <Section style={upperSection}>
              <Heading style={h1}>Ative sua conta!</Heading>
              <Text style={mainText}>
                Obrigado por topar fazer parte dessa brincadeira. Nós queremos ter
                certeza que é realmente você conosco, para isso acesse o link de ativação
              ...
              <Section style={verificationSection}>
                ...
                <Text style={validityText}>
                  (Esta ativação expira em 1 hora)
                </Text>
              </Section>
            </Section>
            <Hr />
